...
export default function Navbar() {
    ...
    const renderMenu = (
        ...
        >
            <MenuItem onClick={() => { return handleMenuClose, navigate("/teacher/profile") }}>Profile</MenuItem>
    ...
    const renderMobileMenu = (
        ...
        >
            ...
            <MenuItem onClick={() => { navigate("/teacher/management") }} >
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static">
                <Toolbar>
                    <img src={logoday} onClick={() => { navigate("/teacher/dashboard") }} alt="DEV TECH EDUCATION" className='navbar_Logo' />

                    <Box sx={{ flexGrow: 1 }} />
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        <IconButton size="large" color="inherit" onClick={() => { navigate("/teacher/management") }} >
                            <AutoStoriesIcon />
                        </IconButton>
                        <IconButton
                            size="large"
