...
function App() {
  return (
    <Routes>
      ...
      <Route path="/referandearn" element={<><Navbar /> <ReferAndEarn /></>} />
      <Route path="/eventsandcontests" element={<><Navbar /> <EventsAndContests /></>} />
      ...
      <Route path="/student/profile" element={<><StudentNavbar /><StudentProfile /></>} />
      <Route path="/student/management" element={<><StudentNavbar /><StudentManagement /></>} />
      <Route path="/student/notifications" element={<><StudentNavbar /><StudentNotifications /></>} />

      {/* Teacher */}

      <Route path="/teacher/dashboard" element={<><TeacherNavbar /><TeacherDashboard /></>} />
      <Route path="/teacher/profile" element={<><TeacherNavbar /><TeacherProfile /></>} />
      <Route path="/teacher/management" element={<><TeacherNavbar /><TeacherManagement /></>} />
      <Route path="/teacher/notifications" element={<><TeacherNavbar /><TeacherNotifications /></>} />

      {/* Admin */}

      <Route path="/admin/dashboard" element={<><AdminNavbar /><AdminDashboard /></>} />
      <Route path="/admin/profile" element={<><AdminNavbar /><AdminProfile /></>} />
      <Route path="/admin/management" element={<><AdminNavbar /><AdminManagement /></>} />
      <Route path="/admin/notifications" element={<><AdminNavbar /><AdminNotifications /></>} />
    </Routes>
  );
}
